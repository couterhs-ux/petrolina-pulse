...
export const restaurants: Business[] = [
  {
    ...
    area: "Av. da Integração",
    description: "Av. da Integração, Petrolina-PE",
    phone: "8799999999",
    rating: 4.5,
    reviews: 372,
    image: rioRooftopImg,
...
export const florists: Business[] = [
  ...
  {
    id: "f2",
    name: "A Roseiral - Flores & Presentes",
    company: "A Roseiral",
    category: "Floriculturas",
    subcategory: "Flores naturais e artificiais • Presentes",
    area: "Areia Branca",
    phone: "87999506430",
    image: roseiralImg,
    price: "A partir de R$ 49",
    tag: "Destaque",
    instagram: "aroseiral1",
  },
  {
    id: "f3",
