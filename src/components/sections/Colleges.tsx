      ...
      <div className="container px-4">
        <div className="flex items-center gap-3 mb-6">
          ...
          <div>
            ...
            <p className="text-sm text-muted-foreground">Cursos e instituições de ensino superior em Petrolina</p>
          </div>
        </div>

        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
          {colleges.map((c) => (
            <article key={c.id} className="bg-card rounded-2xl overflow-hidden shadow-card hover:shadow-sun transition-all">
